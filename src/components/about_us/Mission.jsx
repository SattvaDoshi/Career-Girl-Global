...
//           <h1 className="text-5xl font-bold text-pink-700 mb-4">Our Vision and Mission</h1>
//           <p className="text-xl text-pink-600">Empowering women to achieve their dreams</p>
//         </header>

//         <section className="mb-16">
//           <div className="bg-white p-8 rounded-lg shadow-lg">
//             <h2 className="text-3xl font-semibold text-pink-700 mb-4 text-center">Our Vision</h2>
...
//         <section>
//           <div className="bg-white p-8 rounded-lg shadow-lg">
//             <h2 className="text-3xl font-semibold text-pink-700 mb-4 text-center">Our Mission</h2>
//             <p className="text-gray-700 text-center">
//               At Career Girl Global, our mission is to ignite the potential of young women worldwide by providing them with the essential tools, resources, and guidance to navigate their careers
//               with confidence and achieve outstanding success. We are dedicated to breaking down
//               systemic barriers that hinder women's professional growth and fostering a supportive,
//               empowering community where young women can   learn and thrive. By connecting women
//               with inspirational role models and providing access to a wealth of knowledge, we help
